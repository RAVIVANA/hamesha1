...
public class stockSummaryDAOImp implements stockSummaryDAO {
	...
	public List<stockSummaryModel> getStocks() {
		logger.info("in stockSummaryDAOImp.getStocks() ");
		...
		try {
			...
			logger.error("Error occurred in stockSummaryDAOImp.getStocks() method: {}", e.getMessage());
	...
	public void updateStocks(int prodid, String imageurl, int gstcid, int reorderlevel, int stock, double mrp) {
		...
		logger.info("in stockSummaryDAOImp.updateStocks() ");
		...
		try {
			...
			if (psm != null) {
				...
				System.out.println("Stock not found.");
																					 ...
																					 logger.error("Error occurred in stockSummaryDAOImp.updateStocks() method: {}", e.getMessage());
